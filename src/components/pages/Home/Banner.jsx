...
const Banner = () => {
  ...
  <div className="hero-content flex-col lg:flex-row ">
    <img src= {banne1} className="lg:max-w-md rounded-lg " />
    <div className='w-1/2'>
      <h1 className="text-5xl font-bold ">Adventure Awaits: <br /> Exploring Learning  with Brainbox<span className='text-red-400'>Kiddo</span></h1>
