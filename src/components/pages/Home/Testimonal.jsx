...
const Testimonal = () => {
    return (
        <div>
            ...
            {" "}
            <br />
            <div watchSlidesProgress={true} slidesPerView={3} className="mySwiper grid lg:grid-cols-3 gap-3 ">

                    <div className='card text-center space-y-5 w-full shadow-lg'>
                    ...
                    <div className='card text-center space-y-5 h-full shadow-lg'>
                    ...
                    <div className='card text-center space-y-5 shadow-lg'>
